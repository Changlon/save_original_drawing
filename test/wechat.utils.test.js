...
describe("测试公众号utils",()=>{  
    ...
    describe("测试parseInsLink函数",()=>{
        ...
        it("可以识别instagram链接",()=>{ 
           ...
           expect(result.link).equal("https://instagram.com/p/CJ0VfRFj76Z/") 
           ...
           expect(result.link).equal("http://www.instagram.com/p/BggYTj3l9ms/") 
           expect(result.type).equal("p") 
           ...
           expect(result.link).equal("https://www.instagram.com/e_lludda/p/CY9LYlbBCTc/") 
           expect(result.type).equal("p") 
           ...
           expect(result.link).equal("https://www.instagram.com/p/pm_u28S7Hg/") 
           expect(result.type).equal("p") 
           ...
           expect(result.link).equal("https://www.instagram.com/reel/CYa5TAGvG3S/") 
           ...
           expect(result.link).equal("https://www.instagram.com/perkinizer/tv/CZL5dVFooPq/") 
           ...
           expect(result.link).equal("https://www.instagram.com/thv/") 
